...
#workunit('name','I_infutorcid_fcra_phone_qa.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_infutorcid_fcra_phone_qa,SALT311;
...
ingestMod := I_infutorcid_fcra_phone_qa.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_infutorcid_fcra_phone_qa::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_infutorcid_fcra_phone_qa::ingest::ActiveRecords';
