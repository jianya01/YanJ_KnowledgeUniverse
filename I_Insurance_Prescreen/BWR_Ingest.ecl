...
#workunit('name','I_Insurance_Prescreen.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_Insurance_Prescreen,SALT311;
...
ingestMod := I_Insurance_Prescreen.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_Insurance_Prescreen::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_Insurance_Prescreen::ingest::ActiveRecords';
