...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_trimerge_transaction_log_extension';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_trimerge_transaction_log_extension\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:sequence_smd:TYPE(INTEGER1):0,0\n'
    + 'FIELD:person_type:TYPE(STRING1):0,0\n'
