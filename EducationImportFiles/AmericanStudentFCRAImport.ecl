IMPORT _Control;
AmericanStudentFCRAlayout := RECORD
  unsigned6 l_did;
  integer8 key;
  string9 ssn;
  unsigned6 did;
 ...
 END; 
blankDataset := dataset([], AmericanStudentFCRAlayout);

fileName := '~thor_data400::key::fcra::american_student::qa::did2';

EXPORT AmericanStudentFCRAImport := IF(COUNT(_Control.LexIDFilterSet) <= 0, 
