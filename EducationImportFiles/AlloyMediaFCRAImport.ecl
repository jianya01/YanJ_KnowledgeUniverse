...
blankDataset := dataset([], AlloyMediaFCRAlayout);

fileName := '~thor_data400::key::fcra::alloymedia_student_list::qa::did';

EXPORT AlloyMediaFCRAImport := IF(COUNT(_Control.LexIDFilterSet) <= 0, 
