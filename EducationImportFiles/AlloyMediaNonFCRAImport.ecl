IMPORT _Control;
AlloyMediaNonFCRAlayout := RECORD
  unsigned8 did;
...
blankDataset := dataset([], AlloyMediaNonFCRAlayout);

fileName := '~thor_data400::key::alloymedia_student_list::qa::did';
EXPORT AlloyMediaNonFCRAImport := IF(COUNT(_Control.LexIDFilterSet) <= 0, 
