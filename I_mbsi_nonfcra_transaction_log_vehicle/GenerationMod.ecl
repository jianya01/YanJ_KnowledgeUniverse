...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_mbsi_nonfcra_transaction_log_vehicle';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_mbsi_nonfcra_transaction_log_vehicle\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:plate_data:TYPE(STRING10):0,0\n'
    + 'FIELD:plate_state:TYPE(STRING2):0,0\n'
    + '\n'
    ;
