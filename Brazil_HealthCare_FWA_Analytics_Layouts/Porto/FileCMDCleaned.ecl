...
EXPORT FileCMDCleaned := MODULE
	EXPORT UserDefinition := NORMALIZE(Brazil_HealthCare_FWA_Analytics_Layouts.Porto.UserDefinitions, 11, TRANSFORM({STRING GeneratedKey, STRING100 PatientUserDefinition, STRING100 ProviderUserDefinition, STRING100 MedicalUserDefinition},
	...
	EXPORT ProviderSpecialityCode := NORMALIZE(Brazil_HealthCare_FWA_Analytics_Layouts.Porto.Provider, LEFT.specialitydetails, TRANSFORM({STRING50 providerkey, STRING10 specialitycode}, 
