EXPORT _Config := MODULE
	...
	EXPORT Constants := MODULE(IConstants)
		...
		// need to create it or change the ESP_IPAddress definition below.  See the Installation Notes
		// document distributed in the SALT zip file for additional information.
		IMPORT _Control;
