...
EXPORT Data_Layout := RECORD
  SALT311.StrType Fld1 { MAXLENGTH(200000) };
	UNSIGNED2 FldNo1;
  SALT311.StrType Fld2 { MAXLENGTH(200000) };
	UNSIGNED2 FldNo2;
  END;
...
EXPORT Layout_Profile := RECORD
	SALT311.StrType Fld1;
	DATASET({SALT311.StrType Fld2, REAL Corr}) Correlations;
	END;
