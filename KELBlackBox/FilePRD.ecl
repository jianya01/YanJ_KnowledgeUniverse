...
EXPORT FilePRD := IF(COUNT(_Control.LexIDFilterSet) <= 0, 
	...
	DATASET(fileName, LayoutPRD, THOR, __COMPRESSED__)((UNSIGNED8)LexID IN _Control.LexIDFilterSet AND STD.Date.IsValidDate(STD.Date.FromStringToDate(filedate[1..6] + '01', '%Y%m%d')))); 