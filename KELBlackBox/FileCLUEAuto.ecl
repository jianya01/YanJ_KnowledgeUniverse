...
t_reportidentificationsectionclueautov2report := RECORD
...
t_recapprocessingsectionclueautov2report := RECORD
...
t_generalmessagessectionclueautov2report := RECORD
...
t_groupsearchidentificationsectionclueautov2report := RECORD
   t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
...
t_subjectidentificationsetclueautov2report := RECORD
...
t_subjectidentificationsectionclueautov2report := RECORD
   t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
   DATASET(t_subjectidentificationsetclueautov2report) subjectidset{xpath('SubjectIdSet/SubjectId'), maxcount(50)};
  END;
...
t_vehicleidentificationsetclueautov2report := RECORD
    t_vehiclerecordreport vehicle{xpath('Vehicle')};
    t_unitquotebackrecordreport unitquoteback{xpath('UnitQuoteback')};
   END;

t_vehicleidentificationsectionclueautov2report := RECORD
   t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
   DATASET(t_vehicleidentificationsetclueautov2report) vehicleidset{xpath('VehicleIdSet/VehicleId'), maxcount(50)};
  END;
...
t_consumernarrativesubsetclueautov2report := RECORD
...
t_claimsetclueautov2report := RECORD
    ...
    DATASET(t_consumernarrativesubsetclueautov2report) consumernarrativesubset{xpath('ConsumerNarrativeSubset/ConsumerNarrative'), maxcount(2)};
   END;

t_claimhistory_subjectsectionclueautov2report := RECORD
   t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
   DATASET(t_claimsetclueautov2report) claimset{xpath('ClaimSet/Claim'), maxcount(1250)};
  END;

t_agentclaimsetclueautov2report := RECORD
    t_claiminforecordreport claiminfo{xpath('ClaimInfo')};
    t_vehiclerecordreport vehicle{xpath('Vehicle')};
    DATASET(t_claimpaymentrecordreport) payments{xpath('Payments/ClaimPayment'), maxcount(3)};
    DATASET(t_consumernarrativesubsetclueautov2report) consumernarrativesets{xpath('ConsumerNarrativeSets/ConsumerNarrativeSet'), maxcount(2)};
   END;

t_claimhistory_agentsummarysectionclueautov2report := RECORD
   t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
   DATASET(t_agentclaimsetclueautov2report) claimsets{xpath('ClaimSets/ClaimSet'), maxcount(1250)};
  END;

t_additionaldriverdiscoverysetclueautov2report := RECORD
    t_personrecordreport driver{xpath('Driver')};
    t_driverlicenserecordreport driverslicense{xpath('DriversLicense')};
   END;

t_additionaldriverdiscoverysectionclueautov2report := RECORD
   t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
   DATASET(t_additionaldriverdiscoverysetclueautov2report) additionaldriverdiscoveryset{xpath('AdditionalDriverDiscoverySet/AdditionalDriverDiscovery'), maxcount(10)};
  END;
...
t_vehiclereportidentificationsectionclueautov2report := RECORD
    t_reportrequestidrecordreport reportrequestid{xpath('ReportRequestId')};
    t_reportidsupplementarecordreport reportidsupplementa{xpath('ReportIdSupplementA')};
   END;

t_vehiclerecapprocessingsectionclueautov2report := RECORD
    t_recapprocessingrecordreport inquiryrecap{xpath('InquiryRecap')};
   END;

t_vehiclegeneralmessagessectionclueautov2report := RECORD
    t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
    DATASET(t_narrativearecordreport) messages{xpath('Messages/NarrativeA'), maxcount(99)};
   END;

t_vehicleinquiryownersectionclueautov2report := RECORD
    t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
    t_personrecordreport subject{xpath('Subject')};
    t_addressrecordreport currentaddress{xpath('CurrentAddress')};
   END;
...
t_vehicledevelopeddatasetclueautov2report := RECORD
...
t_vehicledevelopedsectionclueautov2report := RECORD
    t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
    DATASET(t_narrativearecordreport) messages{xpath('Messages/NarrativeA'), maxcount(99)};
    DATASET(t_vehicledevelopeddatasetclueautov2report) vehicledevelopeddatasets{xpath('VehicleDevelopedDataSets/VehicleDevelopedDataSet'), maxcount(25)};
   END;

t_vehicleinformationsectionclueautov2report := RECORD
   t_reportsectionheaderrecordreport reportsectionheader{xpath('ReportSectionHeader')};
   t_vehiclereportidentificationsectionclueautov2report vehiclereportidsection{xpath('VehicleReportIdSection')};
   t_vehiclerecapprocessingsectionclueautov2report vehiclerecapprocessingsection{xpath('VehicleRecapProcessingSection')};
   t_vehiclegeneralmessagessectionclueautov2report vehiclegeneralmessagessection{xpath('VehicleGeneralMessagesSection')};
   t_vehicleinquiryownersectionclueautov2report vehicleinquiryownersection{xpath('VehicleInquiryOwnerSection')};
   t_vehicledevelopedsectionclueautov2report vehicledevelopedsection{xpath('VehicleDevelopedSection')};
  END;

CLUE_Auto_Response := RECORD
  t_insurancexmlinfo xmlinfo{xpath('XmlInfo')};
  t_reportidentificationsectionclueautov2report reportidsection{xpath('ReportIdSection')};
  t_recapprocessingsectionclueautov2report recapprocessingsection{xpath('RecapProcessingSection')};
  t_generalmessagessectionclueautov2report generalmessagessection{xpath('GeneralMessagesSection')};
  t_groupsearchidentificationsectionclueautov2report groupsearchidsection{xpath('GroupSearchIdSection')};
  t_subjectidentificationsectionclueautov2report subjectidsection{xpath('SubjectIdSection')};
  t_vehicleidentificationsectionclueautov2report vehicleidsection{xpath('VehicleIdSection')};
  t_claimhistory_subjectsectionclueautov2report claimhistorysubjectsection{xpath('ClaimHistorySubjectSection')};
  t_claimhistory_subjectsectionclueautov2report claimhistoryvehiclesection{xpath('ClaimHistoryVehicleSection')};
  t_claimhistory_subjectsectionclueautov2report claimhistorypossiblerelatedsection{xpath('ClaimHistoryPossibleRelatedSection')};
  t_claimhistory_agentsummarysectionclueautov2report claimhistoryagentsummarysection{xpath('ClaimHistoryAgentSummarySection')};
  t_additionaldriverdiscoverysectionclueautov2report additionaldriverdiscoverysection{xpath('AdditionalDriverDiscoverySection')};
  t_inquiryhistorysectionclueautov2report inquiryhistorysection{xpath('InquiryHistorySection')};
  t_additionalinformationsectionclueautov2report additionalinformationsection{xpath('AdditionalInformationSection')};
  DATASET(t_generalmessagessectionclueautov2report) attachedproductssections{xpath('AttachedProductsSections/AttachedProductsSection'), maxcount(10)};
  t_attachmentsectionccstandaloneresultscust ccattachsection{xpath('CCAttachSection')};
  t_vehicleinformationsectionclueautov2report vehicleinformationsection{xpath('VehicleInformationSection')};
  string errorcode;
