...
FullRecords := DATASET(KELBlackBox.FileBlackBoxLocation + 'thor::base::cdw::prod::marketview', LayoutMarketView, THOR);
...
OUTPUT(SlimmedRecords,, '~bpahl::base::cdw::prod::marketviewslim', THOR, OVERWRITE);