EXPORT Layout_EditsArchive_Append := RECORD
	...
	UNSIGNED2		NarrativeRemarkCounter; // Eligible NR51 Records assigned a sequence number across a reference number and a Record Type
	UNSIGNED1		SH51Type;								// INQRY Section = 1, IDENT Section = 2
	UNSIGNED1		SH51TypeSeq;						// Sequence number among INQRY AND IDENT Section records
