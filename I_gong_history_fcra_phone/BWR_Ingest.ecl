...
#workunit('name','I_gong_history_fcra_phone.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_gong_history_fcra_phone,SALT311;
...
ingestMod := I_gong_history_fcra_phone.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_gong_history_fcra_phone::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_gong_history_fcra_phone::ingest::ActiveRecords';
