...
StateFarmLayout CleanAttributeNames(RECORDOF(StateFarmKELResults) le) := TRANSFORM
	...
	SELF.SINGAC01 := le.Num_Gen_Med_Not_At_Fault_Clm_Within1_Yr_;
	SELF.SINGAC02 := le.Num_Gen_Med_Not_At_Fault_Clm_Within2_Yr_;
	SELF.SINGAC03 := le.Num_Gen_Med_Not_At_Fault_Clm_Within3_Yr_;
	SELF.SINGAC04 := le.Num_Gen_Med_Not_At_Fault_Clm_Within4_Yr_;
	SELF.SINGAC05 := le.Num_Gen_Med_Not_At_Fault_Clm_Within5_Yr_;
