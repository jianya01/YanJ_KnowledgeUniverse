...
PropertyEntity := KELGlobal.Q_Current_Carrier_Property(CCTransactionID).Res0;
PropertyAll := KELGlobal.Q_Dump_Current_Carrier_Property.Res0;
...
PropertySubjectEntity := KELGlobal.Q_Current_Carrier_Property_Subject(CCTransactionID).Res0;
PropertySubjectAll := KELGlobal.Q_Dump_Current_Carrier_Property_Subject.Res0;
...
PropertyRecapEntity := KELGlobal.Q_Current_Carrier_Property_Recap(CCTransactionID).Res0;
PropertyRecapAll := KELGlobal.Q_Dump_Current_Carrier_Property_Recap.Res0;
...
PropertyAttachmentEntity := KELGlobal.Q_Current_Carrier_Property_Attachment(CCTransactionID).Res0;
PropertyAttachmentAll := KELGlobal.Q_Dump_Current_Carrier_Property_Attachment.Res0;
