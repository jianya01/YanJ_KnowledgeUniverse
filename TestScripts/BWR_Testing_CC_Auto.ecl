...
AutoEntity := KELGlobal.Q_Current_Carrier_Auto(CCTransactionID).Res0;
AutoAll := KELGlobal.Q_Dump_Current_Carrier_Auto.Res0;
...
AutoSubjectEntity := KELGlobal.Q_Current_Carrier_Auto_Subject(CCTransactionID).Res0;
AutoSubjectAll := KELGlobal.Q_Dump_Current_Carrier_Auto_Subject.Res0;
...
AutoRecapEntity := KELGlobal.Q_Current_Carrier_Auto_Recap(CCTransactionID).Res0;
AutoRecapAll := KELGlobal.Q_Dump_Current_Carrier_Auto_Recap.Res0;
...
AutoAttachmentEntity := KELGlobal.Q_Current_Carrier_Auto_Attachment(CCTransactionID).Res0;
AutoAttachmentAll := KELGlobal.Q_Dump_Current_Carrier_Auto_Attachment.Res0;
