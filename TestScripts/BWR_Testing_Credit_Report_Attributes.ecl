...
Transaction := DATASET([{'8815915R3562404', 189543897881}], {STRING TransactionID, UNSIGNED6 LexID}); // Bankruptcies/Collections
...
IncludeDebugQueries := false; // OUTPUT all CreditReport* ENTITY results
	...
	OUTPUT(KELCodeLocation.Q_Credit_Report_V1(Transaction[1].TransactionID).Res0, NAMED('CreditReportRequestData'));
	#end
#else
