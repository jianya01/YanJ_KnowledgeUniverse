...
#workunit('name','CCtlogPol.BWR_Ingest - Ingest - SALT V3.8.0-PV3');
IMPORT CCtlogPol,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := CCtlogPol.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::CCtlogPol::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::CCtlogPol::ingest::ActiveRecords';
