...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_cluecomm_transaction_log_priorpolicyno';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_cluecomm_transaction_log_priorpolicyno\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:prior_policy_number:TYPE(STRING25):0,0\n'
    + 'FIELD:policy_effective_date:TYPE(STRING10):0,0\n'
