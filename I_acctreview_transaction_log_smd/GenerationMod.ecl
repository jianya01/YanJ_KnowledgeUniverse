...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_acctreview_transaction_log_smd';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_acctreview_transaction_log_smd\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:reject_code:TYPE(STRING3):0,0\n'
    + 'FIELD:model:TYPE(STRING4):0,0\n'
    + 'FIELD:version:TYPE(STRING20):0,0\n'
    + 'FIELD:reason_code:TYPE(STRING16):0,0\n'
