...
EXPORT Layout_Report := MODULE
	...
	EXPORT Layout_BankruptcyRecord := RECORD //RecordCode[FI61]
		Common_Data;
		EDITSReport.t_BankruptcyRecordReport;
	END;

	EXPORT Layout_CollectionRecord := RECORD //RecordCode[FI81]
		Common_Data;
		EDITSReport.t_CollectionRecordReport;
	END;
	...
	EXPORT Layout_NonMemberRecord := RECORD //RecordCode[FI95]
		Common_Data;
		EDITSReport.t_NonMemberRecordReport;
	END;

	EXPORT Layout_ForeignBureauRecord := RECORD //RecordCode[IS51]
		Common_Data;
		EDITSReport.t_ForeignBureauRecordReport;
	END;	
	...
	END;	
		...
		EXPORT Layout_CreditReportSummary_CR52 := RECORD //RecordCode[CR52]
		Common_Data;
		EDITSReport.t_CreditReportSummaryEnhancedInformationRecordReport;
	END;	
	
		EXPORT Layout_EnhancedCreditTrade_FI91 := RECORD //RecordCode[FI91]
		Common_Data;
		EDITSReport.t_EnhancedCreditTradeHistoryRecordReport;
	END;	
	
		EXPORT Layout_FinancialPaymentPattern_FI92 := RECORD //RecordCode[FI92]
		Common_Data;
		EDITSReport.t_FinancialPaymentPatternGridRecordReport;
	END;	
	
		EXPORT Layout_FinancialTrendedData_FI93 := RECORD //RecordCode[FI93]
		Common_Data;
		EDITSReport.t_FinancialTrendedDataRecordReport;
	END;	
END;	