...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_cluecomm_transaction_log_business';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_cluecomm_transaction_log_business\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:experian_bin:TYPE(STRING9):0,0\n'
    + 'FIELD:austin_tetra:TYPE(STRING9):0,0\n'
