...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_cluecomm_transaction_log_claim';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_cluecomm_transaction_log_claim\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:claim_no:TYPE(STRING20):0,0\n'
    + 'FIELD:claim_date:TYPE(STRING8):0,0\n'
    + 'FIELD:policy_no:TYPE(STRING20):0,0\n'
    + 'FIELD:policy_type:TYPE(STRING2):0,0\n'
    + 'FIELD:result_section:TYPE(STRING2):0,0\n'
