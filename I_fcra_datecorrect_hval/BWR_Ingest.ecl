...
#workunit('name','I_fcra_datecorrect_hval.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_fcra_datecorrect_hval,SALT311;
...
ingestMod := I_fcra_datecorrect_hval.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_fcra_datecorrect_hval::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_fcra_datecorrect_hval::ingest::ActiveRecords';
