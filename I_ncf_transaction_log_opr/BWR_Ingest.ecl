...
#workunit('name','I_ncf_transaction_log_opr.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_ncf_transaction_log_opr,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_ncf_transaction_log_opr.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_ncf_transaction_log_opr::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_ncf_transaction_log_opr::ingest::ActiveRecords';
