...
#workunit('name','I_vin_inquiry_history.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_vin_inquiry_history,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_vin_inquiry_history.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_vin_inquiry_history::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_vin_inquiry_history::ingest::ActiveRecords';
