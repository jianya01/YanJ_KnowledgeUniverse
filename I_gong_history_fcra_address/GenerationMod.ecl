...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_gong_history_fcra_address';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,vault_date_first_seen,vault_date_last_seen,vault_uid_hash,prim_name,st,z5,prim_range,sec_range,current_flag,business_flag,src,listing_type_bus,listing_type_res,listing_type_gov,publish_code,prior_area_code,phone10,predir,suffix,postdir,unit_desig,p_city_name,v_predir,v_prim_name,v_suffix,v_postdir,v_city_name,z4,county_code,geo_lat,geo_long,msa,designation,name_prefix,name_first,name_middle,name_last,name_suffix,listed_name,caption_text,omit_address,omit_phone,omit_locality,see_also_text,did,hhid,bdid,dt_first_seen,dt_last_seen,current_record_flag,deletion_date,disc_cnt6,disc_cnt12,disc_cnt18,persistent_record_id';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_gong_history_fcra_address\n'
    + 'FILENAME:Vault\n'
