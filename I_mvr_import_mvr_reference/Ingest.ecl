...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  Ingest0 := JOIN( Base0,FilesToIngest0,LEFT.vault_uid_hash=RIGHT.vault_uid_hash AND LEFT.import_ref_value_id=RIGHT.import_ref_value_id AND LEFT.data_type=RIGHT.data_type AND LEFT.data_code=RIGHT.data_code AND LEFT.data_state_postal_code=RIGHT.data_state_postal_code AND LEFT.data_source_code=RIGHT.data_source_code AND LEFT.data_translation1=RIGHT.data_translation1
              AND LEFT.data_translation2=RIGHT.data_translation2 AND LEFT.data_translation3=RIGHT.data_translation3 AND LEFT.data_translation4=RIGHT.data_translation4 AND LEFT.data_translation5=RIGHT.data_translation5 AND LEFT.data_translation6=RIGHT.data_translation6 AND LEFT.data_translation7=RIGHT.data_translation7 AND LEFT.data_translation8=RIGHT.data_translation8 AND LEFT.data_translation9=RIGHT.data_translation9 AND LEFT.data_translation10=RIGHT.data_translation10 AND LEFT.date_added=RIGHT.date_added
              AND LEFT.user_added=RIGHT.user_added AND LEFT.process_status=RIGHT.process_status AND LEFT.process_date=RIGHT.process_date AND LEFT.process_reference_id=RIGHT.process_reference_id AND LEFT.process_priority=RIGHT.process_priority AND LEFT.vault_date_first_seen=RIGHT.vault_date_first_seen AND LEFT.vault_date_last_seen=RIGHT.vault_date_last_seen,MergeData(LEFT,RIGHT),FULL OUTER,HASH);
  ...
  Ingest1 := JOIN( Ingest0(__Tpe=RecordType.Old),Ingest0(__Tpe=RecordType.New),LEFT.vault_uid_hash=RIGHT.vault_uid_hash AND LEFT.import_ref_value_id=RIGHT.import_ref_value_id AND LEFT.data_type=RIGHT.data_type AND LEFT.data_code=RIGHT.data_code AND LEFT.data_state_postal_code=RIGHT.data_state_postal_code AND LEFT.data_source_code=RIGHT.data_source_code AND LEFT.data_translation1=RIGHT.data_translation1
              AND LEFT.data_translation2=RIGHT.data_translation2 AND LEFT.data_translation3=RIGHT.data_translation3 AND LEFT.data_translation4=RIGHT.data_translation4 AND LEFT.data_translation5=RIGHT.data_translation5 AND LEFT.data_translation6=RIGHT.data_translation6 AND LEFT.data_translation7=RIGHT.data_translation7 AND LEFT.data_translation8=RIGHT.data_translation8 AND LEFT.data_translation9=RIGHT.data_translation9 AND LEFT.data_translation10=RIGHT.data_translation10 AND LEFT.date_added=RIGHT.date_added
              AND LEFT.user_added=RIGHT.user_added AND LEFT.process_status=RIGHT.process_status AND LEFT.process_date=RIGHT.process_date AND LEFT.process_reference_id=RIGHT.process_reference_id AND LEFT.process_priority=RIGHT.process_priority AND LEFT.vault_date_last_seen=0 AND RIGHT.vault_date_last_seen=0,MergeData1(LEFT,RIGHT),FULL OUTER,HASH);
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_mvr_import_mvr_reference::Ingest_Cache',EXPIRE(I_mvr_import_mvr_reference.Config.PersistExpire));
