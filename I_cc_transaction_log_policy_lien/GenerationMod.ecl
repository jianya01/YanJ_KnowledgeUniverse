...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_cc_transaction_log_policy_lien';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_cc_transaction_log_policy_lien\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:lien_indicator:TYPE(STRING1):0,0\n'
    + 'FIELD:sequence:TYPE(STRING3):0,0\n'
    + 'FIELD:name:TYPE(STRING50):0,0\n'
    + 'FIELD:street_number:TYPE(STRING8):0,0\n'
    + 'FIELD:street_name:TYPE(STRING20):0,0\n'
