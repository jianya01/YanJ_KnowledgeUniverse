 EXPORT Source :=  project(Constants.Sourcefile, transform(Layout_Vault, 
																																...
																																SELF.vault_rid := 	0;
																																SELF.vault_UID_Hash := HASHMD5(LEFT.transaction_id,LEFT.transaction_type,LEFT.request_data,LEFT.response_data,LEFT.request_format,LEFT.response_format,LEFT.date_added);
																																SELF := LEFT;
																																SELF:=[];
																																));
