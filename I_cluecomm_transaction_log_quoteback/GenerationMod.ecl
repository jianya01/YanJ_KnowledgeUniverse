...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_cluecomm_transaction_log_quoteback';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_cluecomm_transaction_log_quoteback\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:quoteback_name:TYPE(STRING60):0,0\n'
    + 'FIELD:quoteback_value:TYPE(STRING60):0,0\n'
