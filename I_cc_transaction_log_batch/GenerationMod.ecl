...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_cc_transaction_log_batch';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_cc_transaction_log_batch\n'
    + 'FILENAME:Vault \n'
    ...
    + 'FIELD:batch_job_id:TYPE(UNSIGNED4):0,0\n'
    + 'FIELD:batch_seq_number:TYPE(UNSIGNED4):0,0\n'
    ...
    + 'FIELD:broker_node_id:TYPE(STRING9):0,0\n'
    + 'FIELD:handling_option:TYPE(STRING2):0,0\n'
