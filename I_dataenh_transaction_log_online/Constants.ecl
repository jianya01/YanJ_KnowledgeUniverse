...
EXPORT VaultFile := DATASET(BasePrefix+'::prod::'+BaseSuffix, I_dataenh_transaction_log_online.Layout_Vault, thor, opt);
EXPORT SourceKey := 'transaction_id,transaction_type,date_added';
EXPORT ModuleName := 'I_dataenh_transaction_log_online';
