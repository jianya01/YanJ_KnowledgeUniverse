...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  Ingest0 := JOIN( Base0,FilesToIngest0,LEFT.vault_uid_hash=RIGHT.vault_uid_hash AND LEFT.did=RIGHT.did AND LEFT.criminal_count=RIGHT.criminal_count AND LEFT.last_criminal_date=RIGHT.last_criminal_date AND LEFT.felony_count=RIGHT.felony_count AND LEFT.last_felony_date=RIGHT.last_felony_date AND LEFT.criminal_count30=RIGHT.criminal_count30
              AND LEFT.criminal_count90=RIGHT.criminal_count90 AND LEFT.criminal_count180=RIGHT.criminal_count180 AND LEFT.criminal_count12=RIGHT.criminal_count12 AND LEFT.criminal_count24=RIGHT.criminal_count24 AND LEFT.criminal_count36=RIGHT.criminal_count36 AND LEFT.criminal_count60=RIGHT.criminal_count60 AND LEFT.crim_case_num=RIGHT.crim_case_num AND LEFT.arrests_count=RIGHT.arrests_count AND LEFT.date_last_arrest=RIGHT.date_last_arrest AND LEFT.arrests_count30=RIGHT.arrests_count30
              AND LEFT.arrests_count90=RIGHT.arrests_count90 AND LEFT.arrests_count180=RIGHT.arrests_count180 AND LEFT.arrests_count12=RIGHT.arrests_count12 AND LEFT.arrests_count24=RIGHT.arrests_count24 AND LEFT.arrests_count36=RIGHT.arrests_count36 AND LEFT.arrests_count60=RIGHT.arrests_count60 AND LEFT.vault_date_first_seen=RIGHT.vault_date_first_seen AND LEFT.vault_date_last_seen=RIGHT.vault_date_last_seen,MergeData(LEFT,RIGHT),FULL OUTER,HASH);
  ...
  Ingest1 := JOIN( Ingest0(__Tpe=RecordType.Old),Ingest0(__Tpe=RecordType.New),LEFT.vault_uid_hash=RIGHT.vault_uid_hash AND LEFT.did=RIGHT.did AND LEFT.criminal_count=RIGHT.criminal_count AND LEFT.last_criminal_date=RIGHT.last_criminal_date AND LEFT.felony_count=RIGHT.felony_count AND LEFT.last_felony_date=RIGHT.last_felony_date AND LEFT.criminal_count30=RIGHT.criminal_count30
              AND LEFT.criminal_count90=RIGHT.criminal_count90 AND LEFT.criminal_count180=RIGHT.criminal_count180 AND LEFT.criminal_count12=RIGHT.criminal_count12 AND LEFT.criminal_count24=RIGHT.criminal_count24 AND LEFT.criminal_count36=RIGHT.criminal_count36 AND LEFT.criminal_count60=RIGHT.criminal_count60 AND LEFT.crim_case_num=RIGHT.crim_case_num AND LEFT.arrests_count=RIGHT.arrests_count AND LEFT.date_last_arrest=RIGHT.date_last_arrest AND LEFT.arrests_count30=RIGHT.arrests_count30
              AND LEFT.arrests_count90=RIGHT.arrests_count90 AND LEFT.arrests_count180=RIGHT.arrests_count180 AND LEFT.arrests_count12=RIGHT.arrests_count12 AND LEFT.arrests_count24=RIGHT.arrests_count24 AND LEFT.arrests_count36=RIGHT.arrests_count36 AND LEFT.arrests_count60=RIGHT.arrests_count60 AND LEFT.vault_date_last_seen=0 AND RIGHT.vault_date_last_seen=0,MergeData1(LEFT,RIGHT),FULL OUTER,HASH);
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_Key_BocaShell_Did::Ingest_Cache',EXPIRE(I_Key_BocaShell_Did.Config.PersistExpire));
