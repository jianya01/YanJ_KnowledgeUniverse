...
#workunit('name','I_Key_BocaShell_Did.BWR_Ingest - Ingest - SALT V3.8.1');
IMPORT I_Key_BocaShell_Did,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_Key_BocaShell_Did.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_Key_BocaShell_Did::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_Key_BocaShell_Did::ingest::ActiveRecords';
