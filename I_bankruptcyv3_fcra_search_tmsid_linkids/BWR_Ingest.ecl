...
#workunit('name','I_bankruptcyv3_fcra_search_tmsid_linkids.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_bankruptcyv3_fcra_search_tmsid_linkids,SALT311;
...
ingestMod := I_bankruptcyv3_fcra_search_tmsid_linkids.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_bankruptcyv3_fcra_search_tmsid_linkids::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_bankruptcyv3_fcra_search_tmsid_linkids::ingest::ActiveRecords';
