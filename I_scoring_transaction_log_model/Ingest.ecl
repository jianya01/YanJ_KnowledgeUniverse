...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_scoring_transaction_log_model::Ingest_Cache',EXPIRE(I_scoring_transaction_log_model.Config.PersistExpire));
