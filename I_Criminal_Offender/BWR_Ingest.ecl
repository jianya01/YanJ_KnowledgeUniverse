...
#workunit('name','I_Criminal_Offender.BWR_Ingest - Ingest - SALT V3.8.1');
IMPORT I_Criminal_Offender,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_Criminal_Offender.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_Criminal_Offender::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_Criminal_Offender::ingest::ActiveRecords';
