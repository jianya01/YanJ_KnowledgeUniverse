...
#workunit('name','I_fcra_citystzip_qa.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_fcra_citystzip_qa,SALT311;
...
ingestMod := I_fcra_citystzip_qa.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_fcra_citystzip_qa::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_fcra_citystzip_qa::ingest::ActiveRecords';
