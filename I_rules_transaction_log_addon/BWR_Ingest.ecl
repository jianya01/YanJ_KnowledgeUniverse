...
#workunit('name','I_rules_transaction_log_addon.BWR_Ingest - Ingest - SALT V3.8.1');
IMPORT I_rules_transaction_log_addon,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_rules_transaction_log_addon.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_rules_transaction_log_addon::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_rules_transaction_log_addon::ingest::ActiveRecords';
