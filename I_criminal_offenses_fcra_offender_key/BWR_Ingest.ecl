...
#workunit('name','I_criminal_offenses_fcra_offender_key.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_criminal_offenses_fcra_offender_key,SALT311;
...
ingestMod := I_criminal_offenses_fcra_offender_key.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_criminal_offenses_fcra_offender_key::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_criminal_offenses_fcra_offender_key::ingest::ActiveRecords';
