...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_rules_transaction_log_detail';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_rules_transaction_log_detail\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:ruleplan_transaction_id:TYPE(STRING60):0,0\n'
    + 'FIELD:ruleplan_id:TYPE(INTEGER4):0,0\n'
    + 'FIELD:date_added:TYPE(STRING19):0,0\n'
    + 'FIELD:sequence:TYPE(INTEGER1):0,0\n'
    + 'FIELD:product_id:TYPE(INTEGER4):0,0\n'
    + 'FIELD:product_transaction_id:TYPE(STRING60):0,0\n'
    + 'FIELD:product_transaction_id_type:TYPE(STRING12):0,0\n'
    + 'FIELD:processing_status:TYPE(STRING6):0,0\n'
    + 'FIELD:model_id:TYPE(STRING4):0,0\n'
    + 'FIELD:duplicate_report:TYPE(STRING1):0,0\n'
    ;
