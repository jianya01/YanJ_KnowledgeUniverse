...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_sexoffender_fcra_didpublic';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,vault_date_first_seen,vault_date_last_seen,vault_uid_hash,did,seisint_primary_key,lat,long,__internal_fpos__';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_sexoffender_fcra_didpublic\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:lat:TYPE(REAL8):0,0\n'
    + 'FIELD:long:TYPE(REAL8):0,0\n'
