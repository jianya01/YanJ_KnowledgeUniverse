...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_clue_transaction_log_report_code::Ingest_Cache',EXPIRE(I_clue_transaction_log_report_code.Config.PersistExpire));
