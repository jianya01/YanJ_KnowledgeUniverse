...
#workunit('name','I_fcra_override_pii_did.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_fcra_override_pii_did,SALT311;
...
ingestMod := I_fcra_override_pii_did.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_fcra_override_pii_did::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_fcra_override_pii_did::ingest::ActiveRecords';
