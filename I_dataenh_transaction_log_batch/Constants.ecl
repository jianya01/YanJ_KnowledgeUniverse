...
EXPORT VaultFile := DATASET(BasePrefix+'::prod::'+BaseSuffix, I_dataenh_transaction_log_batch.Layout_Vault, thor, opt);
EXPORT SourceKey := 'batch_job_id,batch_seq_number,transaction_type,date_added';
EXPORT ModuleName := 'I_dataenh_transaction_log_batch';
