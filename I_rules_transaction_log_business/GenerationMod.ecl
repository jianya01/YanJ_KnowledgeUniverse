...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_rules_transaction_log_business';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_rules_transaction_log_business\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:business_name:TYPE(STRING120):0,0\n'
    + 'FIELD:dba_name:TYPE(STRING120):0,0\n'
    + 'FIELD:fein:TYPE(STRING9):0,0\n'
    + 'FIELD:line_of_business:TYPE(STRING120):0,0\n'
    + 'FIELD:principal_name:TYPE(STRING120):0,0\n'
    + 'FIELD:subscriber_code:TYPE(STRING9):0,0\n'
