...
#workunit('name','I_corrections_fcra_court_offenses_public.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_corrections_fcra_court_offenses_public,SALT311;
...
ingestMod := I_corrections_fcra_court_offenses_public.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_corrections_fcra_court_offenses_public::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_corrections_fcra_court_offenses_public::ingest::ActiveRecords';
