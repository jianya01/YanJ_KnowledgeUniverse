...
#workunit('name','I_bankruptcyv3_fcra_did.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_bankruptcyv3_fcra_did,SALT311;
...
ingestMod := I_bankruptcyv3_fcra_did.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_bankruptcyv3_fcra_did::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_bankruptcyv3_fcra_did::ingest::ActiveRecords';
