...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_bankruptcyv3_fcra_did';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,vault_date_first_seen,vault_date_last_seen,vault_uid_hash,did,tmsid,court_code,case_number,__internal_fpos__';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_bankruptcyv3_fcra_did\n'
    + 'FILENAME:Vault\n'
