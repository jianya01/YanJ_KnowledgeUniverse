...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_fcra_death_master_ssa_ssn';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,vault_date_first_seen,vault_date_last_seen,vault_uid_hash,ssn,did,did_score,filedate,rec_type,rec_type_orig,lname,name_suffix,fname,mname,vorp_code,dod8,dob8,st_country_code,zip_lastres,zip_lastpayment,state,fipscounty,crlf,state_death_flag,death_rec_src,state_death_id,src,glb_flag,__internal_fpos__';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_fcra_death_master_ssa_ssn\n'
    + 'FILENAME:Vault\n'
