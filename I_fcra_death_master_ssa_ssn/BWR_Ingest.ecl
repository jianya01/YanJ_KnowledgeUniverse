...
#workunit('name','I_fcra_death_master_ssa_ssn.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_fcra_death_master_ssa_ssn,SALT311;
...
ingestMod := I_fcra_death_master_ssa_ssn.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_fcra_death_master_ssa_ssn::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_fcra_death_master_ssa_ssn::ingest::ActiveRecords';
