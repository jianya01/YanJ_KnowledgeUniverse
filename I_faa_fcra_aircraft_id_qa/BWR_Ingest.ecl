...
#workunit('name','I_faa_fcra_aircraft_id_qa.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_faa_fcra_aircraft_id_qa,SALT311;
...
ingestMod := I_faa_fcra_aircraft_id_qa.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_faa_fcra_aircraft_id_qa::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_faa_fcra_aircraft_id_qa::ingest::ActiveRecords';
