...
EXPORT SALT_Profile_Poorly_Populated_Fields(DATASET(SALT37.MAC_Character_Counts.ResultLine_Layout) InputSALTProfile, INTEGER NumberOfDataPatternsToShow = 5, REAL MinimumPercentBlank = 50.0) := FUNCTION
