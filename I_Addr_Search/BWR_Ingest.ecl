...
#workunit('name','I_Addr_Search.BWR_Ingest - Ingest - SALT V3.8.1');
IMPORT I_Addr_Search,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_Addr_Search.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_Addr_Search::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_Addr_Search::ingest::ActiveRecords';
