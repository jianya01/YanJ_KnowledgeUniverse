...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_mvr_transaction_report_view_log';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_mvr_transaction_report_view_log\n'
    + 'FILENAME:Vault\n'
    ...
    + '\n'
    + 'FIELD:report_view_log_id:TYPE(INTEGER4):0,0\n'
    + 'FIELD:transaction_id:TYPE(STRING20):0,0\n'
    + 'FIELD:consumer_id:TYPE(INTEGER4):0,0\n'
    ...
    + 'FIELD:purpose:TYPE(STRING100):0,0\n'
