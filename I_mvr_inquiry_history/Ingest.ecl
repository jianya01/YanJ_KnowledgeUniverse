...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_mvr_inquiry_history::Ingest_Cache',EXPIRE(I_mvr_inquiry_history.Config.PersistExpire));
