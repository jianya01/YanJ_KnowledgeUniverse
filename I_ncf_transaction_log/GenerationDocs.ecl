...
Command line options: -MI_ncf_transaction_log -eC:\Users\garush01\AppData\Local\Temp\TFRE9E5.tmp 
File being processed :-
OPTIONS:-gn
MODULE:I_ncf_transaction_log
FILENAME:Vault
...
FIELD:consumer_number:TYPE(STRING11):0,0
...
FIELD:dupe_keys_selected:TYPE(STRING11):0,0
...
FIELD:carrier_cnt:TYPE(STRING4):0,0
FIELD:record_version:TYPE(STRING4):0,0
...
FIELD:report_options:TYPE(STRING2):0,0
...
FIELD:response_time:TYPE(STRING8):0,0
...
FIELD:date_changed:TYPE(STRING24):0,0
FIELD:individual_lex_id:TYPE(UNSIGNED6):0,0
FIELD:spouse_lex_id:TYPE(UNSIGNED6):0,0
