...
#workunit('name','I_cc_transaction_log_policy.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_cc_transaction_log_policy,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_cc_transaction_log_policy.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_cc_transaction_log_policy::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_cc_transaction_log_policy::ingest::ActiveRecords';
