...
#workunit('name','I_CCFC_transaction_log_batch.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_CCFC_transaction_log_batch,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_CCFC_transaction_log_batch.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_CCFC_transaction_log_batch::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_CCFC_transaction_log_batch::ingest::ActiveRecords';
