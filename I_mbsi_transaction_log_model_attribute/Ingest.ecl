...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_mbsi_transaction_log_model_attribute::Ingest_Cache',EXPIRE(I_mbsi_transaction_log_model_attribute.Config.PersistExpire));
