...
#workunit('name','I_dataenh_transaction_log.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_dataenh_transaction_log,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_dataenh_transaction_log.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_dataenh_transaction_log::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_dataenh_transaction_log::ingest::ActiveRecords';
