...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_CDSC_transaction_log_online::Ingest_Cache',EXPIRE(I_CDSC_transaction_log_online.Config.PersistExpire));
