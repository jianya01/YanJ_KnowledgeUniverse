...
#workunit('name','I_mpo_transaction_log_online.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_mpo_transaction_log_online,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_mpo_transaction_log_online.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_mpo_transaction_log_online::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_mpo_transaction_log_online::ingest::ActiveRecords';
