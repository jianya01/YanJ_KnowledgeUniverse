...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_rules_transaction_log_vendor';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_rules_transaction_log_vendor\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:vendor_sequence:TYPE(INTEGER1):0,0\n'
    + 'FIELD:vendor_code:TYPE(STRING3):0,0\n'
