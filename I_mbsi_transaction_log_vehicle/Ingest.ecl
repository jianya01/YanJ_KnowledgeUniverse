...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_mbsi_transaction_log_vehicle::Ingest_Cache',EXPIRE(I_mbsi_transaction_log_vehicle.Config.PersistExpire));
