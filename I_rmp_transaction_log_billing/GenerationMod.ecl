...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_rmp_transaction_log_billing';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_rmp_transaction_log_billing\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:billed_report_code:TYPE(STRING20):0,0\n'
    + 'FIELD:position:TYPE(INTEGER4):0,0\n'
    + 'FIELD:amount:TYPE(DECIMAL10):0,0\n'
    + 'FIELD:billing_id:TYPE(STRING10):0,0\n'
