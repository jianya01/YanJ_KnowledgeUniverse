...
#workunit('name','I_clue_transaction_log_person.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_clue_transaction_log_person,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_clue_transaction_log_person.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_clue_transaction_log_person::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_clue_transaction_log_person::ingest::ActiveRecords';
