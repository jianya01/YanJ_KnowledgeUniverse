...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_clue_transaction_log_person';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_clue_transaction_log_person\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:current_state:TYPE(STRING2):0,0\n'
    ...
    + 'FIELD:former_state:TYPE(STRING2):0,0\n'
    ...
    + 'FIELD:lex_id:TYPE(UNSIGNED6):0,0\n'
