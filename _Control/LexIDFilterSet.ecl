EXPORT LexIDFilterSet := DATASET([22, 59, 78, 117, 137, 205, 224, 302, 313, 315, 318, 365], {UNSIGNED8 LexID}); // Include every single LexID in the base files (Full File Runs)
