...
, DATASET(RECORDOF(Source))  infile = Source
  ...
  Ingest0 := JOIN( Base0,FilesToIngest0,LEFT.vault_uid_hash=RIGHT.vault_uid_hash AND LEFT.transaction_id=RIGHT.transaction_id AND LEFT.dmv_submission_date=RIGHT.dmv_submission_date AND LEFT.pre_search_period_used=RIGHT.pre_search_period_used AND LEFT.delivery_mode=RIGHT.delivery_mode AND LEFT.no_charge_registry=RIGHT.no_charge_registry AND LEFT.renp_searched=RIGHT.renp_searched
              AND LEFT.sbaws_searched=RIGHT.sbaws_searched AND LEFT.force_dmv=RIGHT.force_dmv AND LEFT.no_dmv_request=RIGHT.no_dmv_request AND LEFT.amp_request=RIGHT.amp_request AND LEFT.detail_type_1=RIGHT.detail_type_1 AND LEFT.detail_value_1=RIGHT.detail_value_1 AND LEFT.detail_type_2=RIGHT.detail_type_2 AND LEFT.detail_value_2=RIGHT.detail_value_2 AND LEFT.detail_type_3=RIGHT.detail_type_3 AND LEFT.detail_value_3=RIGHT.detail_value_3
              AND LEFT.detail_type_4=RIGHT.detail_type_4 AND LEFT.detail_value_4=RIGHT.detail_value_4 AND LEFT.detail_type_5=RIGHT.detail_type_5 AND LEFT.detail_value_5=RIGHT.detail_value_5 AND LEFT.date_added=RIGHT.date_added AND LEFT.vault_date_first_seen=RIGHT.vault_date_first_seen AND LEFT.vault_date_last_seen=RIGHT.vault_date_last_seen,MergeData(LEFT,RIGHT),FULL OUTER,HASH);
  ...
  Ingest1 := JOIN( Ingest0(__Tpe=RecordType.Old),Ingest0(__Tpe=RecordType.New),LEFT.vault_uid_hash=RIGHT.vault_uid_hash AND LEFT.transaction_id=RIGHT.transaction_id AND LEFT.dmv_submission_date=RIGHT.dmv_submission_date AND LEFT.pre_search_period_used=RIGHT.pre_search_period_used AND LEFT.delivery_mode=RIGHT.delivery_mode AND LEFT.no_charge_registry=RIGHT.no_charge_registry AND LEFT.renp_searched=RIGHT.renp_searched
              AND LEFT.sbaws_searched=RIGHT.sbaws_searched AND LEFT.force_dmv=RIGHT.force_dmv AND LEFT.no_dmv_request=RIGHT.no_dmv_request AND LEFT.amp_request=RIGHT.amp_request AND LEFT.detail_type_1=RIGHT.detail_type_1 AND LEFT.detail_value_1=RIGHT.detail_value_1 AND LEFT.detail_type_2=RIGHT.detail_type_2 AND LEFT.detail_value_2=RIGHT.detail_value_2 AND LEFT.detail_type_3=RIGHT.detail_type_3 AND LEFT.detail_value_3=RIGHT.detail_value_3
              AND LEFT.detail_type_4=RIGHT.detail_type_4 AND LEFT.detail_value_4=RIGHT.detail_value_4 AND LEFT.detail_type_5=RIGHT.detail_type_5 AND LEFT.detail_value_5=RIGHT.detail_value_5 AND LEFT.date_added=RIGHT.date_added AND LEFT.vault_date_last_seen=0 AND RIGHT.vault_date_last_seen=0,MergeData1(LEFT,RIGHT),FULL OUTER,HASH);
  ...
  SHARED AllRecs := ORe+NR1+NR(vault_rid<>0) : PERSIST('~temp::I_mvr_transaction_log_billing::Ingest_Cache',EXPIRE(I_mvr_transaction_log_billing.Config.PersistExpire));
