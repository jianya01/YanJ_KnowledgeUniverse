...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_CCFC_transaction_log_billing';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_CCFC_transaction_log_billing\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:account_base_suffix:TYPE(STRING9):0,0\n'
    + 'FIELD:reference_number:TYPE(INTEGER4):0,0\n'
    + 'FIELD:customer_number:TYPE(STRING15):0,0\n'
