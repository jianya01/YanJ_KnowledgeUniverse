...
#workunit('name','I_fcra_aid_rawaid_to_acecahe.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_fcra_aid_rawaid_to_acecahe,SALT311;
...
ingestMod := I_fcra_aid_rawaid_to_acecahe.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_fcra_aid_rawaid_to_acecahe::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_fcra_aid_rawaid_to_acecahe::ingest::ActiveRecords';
