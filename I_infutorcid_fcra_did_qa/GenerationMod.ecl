...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_infutorcid_fcra_did_qa';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,vault_date_first_seen,vault_date_last_seen,vault_uid_hash,did,persistent_record_id,phone,fname,lname,prim_range,predir,prim_name,addr_suffix,postdir,unit_desig,sec_range,p_city_name,v_city_name,st,zip,zip4,rec_type,county,geo_lat,geo_long,geo_blk,dt_first_seen,dt_last_seen';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_infutorcid_fcra_did_qa\n'
    + 'FILENAME:Vault\n'
