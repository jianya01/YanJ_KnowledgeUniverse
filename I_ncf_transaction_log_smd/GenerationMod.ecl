...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spc_MODULE := 'I_ncf_transaction_log_smd';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_ncf_transaction_log_smd\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:individual_score:TYPE(STRING11):0,0\n'
    + 'FIELD:spouse_score:TYPE(STRING11):0,0\n'
    + 'FIELD:exception_state_used:TYPE(STRING2):0,0\n'
