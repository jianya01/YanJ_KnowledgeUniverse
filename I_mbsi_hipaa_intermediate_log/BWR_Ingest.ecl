...
#workunit('name','I_mbsi_hipaa_intermediate_log.BWR_Ingest - Ingest - SALT V3.8.1');
IMPORT I_mbsi_hipaa_intermediate_log,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_mbsi_hipaa_intermediate_log.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_mbsi_hipaa_intermediate_log::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_mbsi_hipaa_intermediate_log::ingest::ActiveRecords';
