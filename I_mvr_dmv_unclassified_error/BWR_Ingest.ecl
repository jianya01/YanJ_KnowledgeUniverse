...
#workunit('name','I_mvr_dmv_unclassified_error.BWR_Ingest - Ingest - SALT V3.8.0');
IMPORT I_mvr_dmv_unclassified_error,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_mvr_dmv_unclassified_error.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_mvr_dmv_unclassified_error::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_mvr_dmv_unclassified_error::ingest::ActiveRecords';
