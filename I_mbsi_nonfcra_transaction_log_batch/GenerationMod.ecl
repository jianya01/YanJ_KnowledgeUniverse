...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_mbsi_nonfcra_transaction_log_batch';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_mbsi_nonfcra_transaction_log_batch\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:batch_job_id:TYPE(STRING20):0,0\n'
    + 'FIELD:batch_seq_number:TYPE(STRING16):0,0\n'
    ...
    + 'FIELD:user_added:TYPE(STRING8):0,0\n'
