...
#workunit('name','I_watchdog_best_fcra_nonen_did.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_watchdog_best_fcra_nonen_did,SALT311;
...
ingestMod := I_watchdog_best_fcra_nonen_did.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_watchdog_best_fcra_nonen_did::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_watchdog_best_fcra_nonen_did::ingest::ActiveRecords';
