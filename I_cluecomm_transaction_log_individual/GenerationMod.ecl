...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'I_cluecomm_transaction_log_individual';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:I_cluecomm_transaction_log_individual\n'
    + 'FILENAME:Vault\n'
    ...
    + 'FIELD:middle_name:TYPE(STRING15):0,0\n'
    + 'FIELD:suffix_name:TYPE(STRING4):0,0\n'
