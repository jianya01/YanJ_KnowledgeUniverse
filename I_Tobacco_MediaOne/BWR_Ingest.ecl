...
#workunit('name','I_Tobacco_MediaOne.BWR_Ingest - Ingest - SALT V3.8.1');
IMPORT I_Tobacco_MediaOne,SALT38;
//If you are not ingesting as part of a header build you can use the below;
//Set CloseOlds to TRUE to ensure that all 'Old' open records will be closed
ingestMod := I_Tobacco_MediaOne.Ingest(FALSE);
f_AllRecords := '~temp::vault_rid::I_Tobacco_MediaOne::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_Tobacco_MediaOne::ingest::ActiveRecords';
