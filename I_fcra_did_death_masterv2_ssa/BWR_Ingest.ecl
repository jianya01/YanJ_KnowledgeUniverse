...
#workunit('name','I_fcra_did_death_masterv2_ssa.BWR_Ingest - Ingest - SALT V3.11.2');
IMPORT I_fcra_did_death_masterv2_ssa,SALT311;
...
ingestMod := I_fcra_did_death_masterv2_ssa.Ingest(CloseOlds, EndDate);
f_AllRecords := '~temp::vault_rid::I_fcra_did_death_masterv2_ssa::ingest::AllRecords';
f_ActiveRecords := '~temp::vault_rid::I_fcra_did_death_masterv2_ssa::ingest::ActiveRecords';
